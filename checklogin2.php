...
<?php
	...
	$result2=mysql_query("SELECT id,password FROM secretariat WHERE id='$_POST[myusername]'and password='$_POST[mypassword]'");
	while($row = mysql_fetch_array($result2)) 
	{
	$print_fullname = $row['id'] ;
	}
	$_SESSION['fullname']=$print_fullname;

	$result=mysql_query("SELECT * FROM secretariat WHERE id='$_POST[myusername]'and password='$_POST[mypassword]'");
	...
	header("location:main_login2f.php");
	}
?>
</body>
</html>
