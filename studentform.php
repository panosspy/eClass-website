<!--Σε αυτη τη σελιδα ο χρηστης συμπληρωνει μια φορμα για να εισαγει στη βαση καινουργιο φοιτητη-->
<?php
session_start();
...
<div class="content">
  ...
  <div id="main">
    <div class="center">
		...
		<h2>Add Student</h2>
		<p>Fill the form below to add a student in database</p>
		...
		else{header("location:send_studentform_fail.php");}
		}
