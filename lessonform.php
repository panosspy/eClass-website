<!--Σε αυτη τη σελιδα ο χρηστης συμπληρωνει μια φορμα για να εισαγει στη βαση καινουργιο μαθημα-->
<?php
session_start();
...
<html>
<head>
<title>University - E-Lesson platform/Add lesson</title>
...
<div class="content">
  ...
  <div id="main">
    <div class="center">
		...
		else{header("location:send_lessonform_fail.php");}
		}
