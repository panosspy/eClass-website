<!--Σε αυτη τη σελιδα ερχεται ο χρηστης οταν το update που εχει κανει στον πινακα student εχει ολοκληρωθει με επιτυχεια
οπου μπορει να δει και το αποτελεσμα -->
<?php
session_start();
