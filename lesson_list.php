<!--Σε αυτη τη σελιδα εμφανιζουμε ολα τα μαθηματα που εχει κανει εγγραφει ο φοιτητς-->
<?php
session_start();
...
<html>
<head>
<title>University - E-Lesson platform/My Lessons</title>
...
<div class="content">
  ...
  <div id="main">
    <div class="center">
        ...
        <h2>My Lessons for this semester</h2>
		<?php
