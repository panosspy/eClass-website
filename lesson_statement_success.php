<!--Ο χρηστης ερχεται σε αυτη τη σελιδα οταν εχει συμπληρωσει σωστα τη φορμα για να δηλωσει το μαθημα που θελει οπου
του εμφανιζει τα δηλωμενα του μαθηματα και του λεει οτι η δηλωσει του εχει γινει σωστα-->
<?php
session_start();
